...
function App() {
  ...
  return (
    <>
      ...
      <main>
        <div className='main bg-gray-900  flex justify-center'>
          <div className='text-3xl py-10 text-white font-bold xl:text-4xl'>Spooky Season is Here!</div>
        </div>
        <div className='main bg-gray-900  flex justify-center '>
        ...
        <div className='main bg-gray-900  flex justify-center  text-white text-center py-10'>
          <div className='w-[80vw] font-serif text-sm xl:text-2xl '>
        ...
        <div className='main bg-gray-900  flex justify-center' >
        <img src="https://i.pinimg.com/originals/32/cd/0b/32cd0bb0462704dab050067adb1de597.gif" alt="" className='w-4/5 xl:w-[30vw]'/>
        {/* <img src="https://giffiles.alphacoders.com/158/15899.gif" alt="" className='w-4/5 xl:w-[30vw]'/> */}
        </div>
        <div className='main bg-gray-900  flex justify-center h-10 xl:h-16'>
        </div>
      </main>
    </>
  )
